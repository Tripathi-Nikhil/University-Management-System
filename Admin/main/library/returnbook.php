...
<body id="body-pd">
    ...
    <div class="row">
        ...
        <div class="col-md-6 card">
            <form action="_library/bookreturn.php" method="POST">
                    <div class="form-group d-flex">
                        <input type="text" name="search_text" id="search_text" placeholder="Enter Student Id"
